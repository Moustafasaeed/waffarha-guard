...
export default function App(){
  ...
  const adminConfig={
    ...
    tabs:[
      {id:"paymethods",label:"💳 Pay Method Abuse",rows:adminPayMethodsAdapted,accent:"#dc2626",cfg:{ccLabel:"Payment Method",cartLabel:"Transaction ID",showOS:true,showECI:false,showCountries:false,hideAuthMsg:true,showBiller:true,showPayMethod:true}},
      ...
      {id:"highamount",label:"💰 High Amounts",rows:adminHighAmtAdapted,accent:"#065f46",cfg:{ccLabel:"Payment Method",cartLabel:"Transaction ID",showOS:true,showECI:false,showCountries:false,hideAuthMsg:true,showBiller:true,showPayMethod:true}},
      {id:"fakedomain",label:"📧 Fake Domain",rows:adminFakeDomAdapted,accent:"#7c3aed",cfg:{ccLabel:"Payment Method",cartLabel:"Transaction ID",showOS:true,showECI:false,showCountries:false,hideAuthMsg:true,showBiller:true,showPayMethod:true}},
