...
export default function App(){
  ...
  // ── PayTabs state ──
  const [ptSessionId,setPtSessionId]=useState(null);
  const [noonSessionId,setNoonSessionId]=useState(null);
  const [pmWSessionId,setPmWSessionId]=useState(null);
  const [pmBSessionId,setPmBSessionId]=useState(null);
  const [adminSessionId,setAdminSessionId]=useState(null);
  const [fawrySessionId,setFawrySessionId]=useState(null);
  const [promoSessionId,setPromoSessionId]=useState(null);
  ...
  const ptConfig={
    ...
    ...blockProps,
    analysisPayload:ptSessionId?{platform:"PayTabs",sessionId:ptSessionId,recordCount:ptRaw.length}:null,
  };
  ...
  const noonConfig={
    ...
    ...blockProps,
    analysisPayload:noonSessionId?{platform:"Noon",sessionId:noonSessionId,recordCount:noonMerged.length}:null,
  };
  ...
  const pmWConfig={
    ...
    ...blockProps,
    analysisPayload:pmWSessionId?{platform:"PayMob Wallets",sessionId:pmWSessionId,recordCount:pmRaw.length}:null,
  };
  ...
  const pmBConfig={
    ...
    ...blockProps,
    analysisPayload:pmBSessionId?{platform:"PayMob BNPL",sessionId:pmBSessionId,recordCount:pmBEnriched.length}:null,
  };
  ...
  const adminConfig={
    ...
    ...blockProps,
    analysisPayload:adminSessionId?{platform:"Admin",sessionId:adminSessionId,recordCount:adminSheetRaw.length}:null,
  };
  ...
  const fawryConfig={
    ...
    ...blockProps,
    analysisPayload:fawrySessionId?{platform:"Fawry",sessionId:fawrySessionId,recordCount:fawryRaw.length}:null,
  };
  ...
  const promoConfig={
    ...
    ...blockProps,
    analysisPayload:promoSessionId?{platform:"Promo",sessionId:promoSessionId,recordCount:promoRaw.length}:null,
  };
